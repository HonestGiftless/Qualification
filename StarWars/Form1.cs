namespace WinFormsApp3
{
    ...
    {
        char ch;
        bool hasRocket = true; // можно ли запустить ракету
        Random random = new Random(); // для генерации случайной позиции
        ...
        private void Form1_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (ch == 'a') pictureBox1.Left -= 10;
            if (ch == 'w') pictureBox1.Top -= 10;
            if (ch == 'x') pictureBox1.Top += 10;
            if (ch == 32)
            {
                if (hasRocket)
                {
